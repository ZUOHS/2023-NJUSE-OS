...
PUBLIC  SEMAPHORE read_write_mutex = {1, 0, 0};
PUBLIC  SEMAPHORE write_mutex = {1, 0, 0};
PUBLIC  SEMAPHORE read_mutex = {1, 0, 0};
PUBLIC  SEMAPHORE wait_mutex = {1, 0, 0};
PUBLIC  SEMAPHORE read_count_mutex = {MAX_READERS, 0, 0};